...
const About = () => {
  return (
    <section className='container mx-auto mb-8' id='about'>
        <h2 className='mb-8 text-center text-3xl tracking-tighter lg:text-4xl font-semibold'>About Us</h2>
        <div className='flex flex-wrap'>
            ...
            <div className='w-full px-2 lg:w-1/2'>
                ...
                <p className='mb-8 text-2xl leading-relaxed tracking-tight lg:max-w-xl'>
                    {ABOUT.content}
                </p>
            </div>
        </div>
